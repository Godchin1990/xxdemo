...
public class LauncherActivity extends Activity {
    ...
    private void startRecordActivity() {
        ...
        _CreateInfo.setOutputThumbnailSize(Integer.parseInt(edit_output_video_width.getText().toString()), Integer.parseInt(edit_output_video_height.getText().toString()));//输出图片宽高
    ...
    private void startUpload() {
        ...
        uploadService.setQupaiUploadListener(new QupaiUploadListener() {
            ...
            public void onUploadComplte(String uuid, int responseCode, String responseMessage) {
                ...
                Log.i("TAG", "data:onUploadComplte" + "uuid:" + uuid + "videoUrl:" + videoUrl);
            }
        });
